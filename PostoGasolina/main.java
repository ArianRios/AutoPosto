...
public class main {
    public static void main(String[] args) {
        ...
        Bomba bombaGasolina = new Bomba(0, tanqueGasolina, 0);
        Bomba bombaAlcool = new Bomba(1, tanqueGasolina, 0);
        while (true) {
            ...
            + "\n5 - Sair", "Digite uma opção válida\n");
            ...
            switch (opcao) {
                case 1:
                    ...
                    if (tipoCase1 == 1) {
                        ...
                        IO.prin("Tipo de combustível inválido.");
                    }
                    break;
                case 2:
